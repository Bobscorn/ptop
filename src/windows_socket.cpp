...
unique_ptr<IReusableNonBlockingConnectSocket> windows_reusable_nonblocking_listen_socket::accept_connection()
{
    SOCKET accepted_socket = accept(_socket, NULL, NULL);

    if (accepted_socket == INVALID_SOCKET)
        return nullptr;
    return make_unique<windows_reusable_nonblocking_connection_socket>(accepted_socket);
}

windows_reusable_nonblocking_connection_socket::windows_reusable_nonblocking_connection_socket(string peer_address, string port)
{
    SOCKET ConnectSocket = INVALID_SOCKET;
